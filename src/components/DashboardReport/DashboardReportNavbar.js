  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-white shadow-md">
      ...
      <div className="flex items-center space-x-6 text-gray-500">
        ...
        <a href="/dashboard" className="hover:text-grey-800 font-medium">Dashboard</a>
        <a href="/dashboard-report" className="text-blue-500">Report</a>
...
export default DashBoardReportNavbar;
