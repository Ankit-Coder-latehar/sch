...
const DistanceTable = () => {
  const tableData = [
    { date: '17/02/2024', vehicleNumber: 'HR EEEE 2344', distance: '555 Km' },
    { date: '17/02/2024', vehicleNumber: 'HR EEEE 2344', distance: '555 Km' },
    { date: '17/02/2024', vehicleNumber: 'HR EEEE 2344', distance: '555 Km' },
    { date: '17/02/2024', vehicleNumber: 'HR EEEE 2344', distance: '555 Km' },
    { date: '17/02/2024', vehicleNumber: 'HR EEEE 2344', distance: '555 Km' },
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div>
        ...
        <a href='/daily-report'><button className="px-4 py-2 text-sm font-medium hover:text-blue-600 bg-white border rounded shadow-sm">
          ...
          <a href='/distance-report'><button className="px-4 py-2 text-sm font-medium text-blue-600 bg-white border rounded shadow-sm">
            Distance Report
          </button></a>
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr className="w-full bg-blue-600 text-white text-left">
              ...
              <th className="py-3 px-6 text-xs font-semibold uppercase tracking-wide">Distance Travelled</th>
            </tr>
          </thead>
          <tbody className="text-gray-700">
            {tableData.map((data, index) => (
              <tr key={index} className="border-b">
                ...
                <td className="py-3 px-6">{data.distance}</td>
              </tr>
            ))}
          </tbody>
        </table>
