    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div>
        ...
        <a href='/daily-report'><button className="px-4 py-2 text-sm font-medium hover:text-blue-600 bg-white border rounded shadow-sm">
          ...
          <a href='/relay'><button className="px-4 py-2 text-sm font-medium text-blue-600 bg-white border rounded shadow-sm">
...
export default RelayEngineTable;